...
# Model Architecture
commandLineParser.add_argument('--model_name', type=str, default='lenet5', choices=['lenet5'],
                               help='model name')
...
commandLineParser.add_argument('--lr', type=float, default=0.01,
                               help='learning rate')
...
def main(argv=None):
    ...
    if not os.path.isdir('CMDs'):
        os.mkdir('CMDs')
    with open('CMDs/step_setup_lenet.cmd', 'a') as f:
