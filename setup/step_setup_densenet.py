...
# Model Architecture
commandLineParser.add_argument('--model_name', type=str, default='densenet', choices=['densenet', 'torch_densenet', 'densenet121', 'densenet169', 'densenet201', 'densenet161'],
                               help='model name')
...
def main(argv=None):
    ...
    if not os.path.isdir('CMDs'):
        os.mkdir('CMDs')
    with open('CMDs/step_setup_densenet.cmd', 'a') as f:
