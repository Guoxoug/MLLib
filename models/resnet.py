...
def obtain_resnet(model_name = 'wide_resnet50_2', num_classes=100, dropout_rate=0):
    if model_name == 'resnet18':
        return resnet18(num_classes=num_classes, dropout_rate=dropout_rate)
    elif model_name == 'resnet34':
        return resnet34(num_classes=num_classes, dropout_rate=dropout_rate)
    if model_name == 'resnet50':
        return resnet50(num_classes=num_classes, dropout_rate=dropout_rate)
    if model_name == 'resnet101':
        return resnet101(num_classes=num_classes, dropout_rate=dropout_rate)
    if model_name == 'resnet152':
        return resnet152(num_classes=num_classes, dropout_rate=dropout_rate)
    if model_name == 'resnext50_32x4d':
        return resnext50_32x4d(num_classes=num_classes, dropout_rate=dropout_rate)
    if model_name == 'resnext101_32x8d':
        return resnext101_32x8d(num_classes=num_classes, dropout_rate=dropout_rate)
    if model_name == 'wide_resnet50_2':
        return wide_resnet50_2(num_classes=num_classes, dropout_rate=dropout_rate)
    if model_name == 'wide_resnet101_2':
        return wide_resnet101_2(num_classes=num_classes, dropout_rate=dropout_rate)
